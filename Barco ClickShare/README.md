...
| ```PresentSensePromotionShown``` | (See below) | ```./User/Vendor/MSFT/Policy/Config/ClickShare~Policy~BarcoClickShare/PresentSensePromotionShown``` | String | ```<enabled/> <data id="PresentSensePromotionShown" value="false"/>```

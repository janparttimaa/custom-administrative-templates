...
> [!NOTE]  
> These ADMX and ADML templates on this repository are forked and further developed from [original templates](https://www.adobe.com/devnet-docs/acrobatetk/tools/DesktopDeployment/gpo.html) provided by Adobe. This is because Adobe's original templates covers only few settings, the original templates are not actively updated and developed by Adobe plus the Adobe's original templates are not suitable for Intune-deployment using ingestion.
...
| ```bBoxConnectorEnabled``` | [See below](#bBoxConnectorEnabled) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bBoxConnectorEnabled``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bDisablePDFHandlerSwitching``` | [See below](#bDisablePDFHandlerSwitching) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bDisablePDFHandlerSwitching``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bDisableSharePointFeatures``` | [See below](#bDisableSharePointFeatures)  | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bDisableSharePointFeatures``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bDisplayAboutDialog``` | [See below](#bDisplayAboutDialog) | ```./User/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bDisplayAboutDialog``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bDropboxConnectorEnabled``` | [See below](#bDropboxConnectorEnabled)  | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bDropboxConnectorEnabled``` | String | ```<enabled/>```
| ```bEnableAV2Enterprise``` | [See below](#bEnableAV2Enterprise) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bEnableAV2Enterprise``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bGoogleDriveConnectorEnabled``` | [See below](#bGoogleDriveConnectorEnabled) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bGoogleDriveConnectorEnabled``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bOneDriveConnectorEnabled``` | [See below](#bOneDriveConnectorEnabled)  | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bOneDriveConnectorEnabled``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bShowMsgAtLaunch``` | [See below](#bShowMsgAtLaunch) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bShowMsgAtLaunch``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bSuppressSignOut``` | [See below](#bSuppressSignOut) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bSuppressSignOut``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bToggleAdobeDocumentServices``` | [See below](#bToggleAdobeDocumentServices) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bToggleAdobeDocumentServices``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bToggleAdobeSign``` | [See below](#bToggleAdobeSign) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bToggleAdobeSign``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bToggleFTE``` | [See below](#bToggleFTE) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bToggleFTE``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bToggleManageSign``` | [See below](#bToggleManageSign) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bToggleManageSign``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bToggleNotifications``` | [See below](#bToggleNotifications) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bToggleNotifications``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bTogglePrefsSync``` | [See below](#bTogglePrefsSync) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bTogglePrefsSync``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bToggleSendACopy``` | [See below](#bToggleSendACopy) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bToggleSendACopy``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bToggleShareFeedback``` | [See below](#bToggleShareFeedback) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bToggleShareFeedback``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bToggleWebConnectors``` | [See below](#bToggleWebConnectors) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bToggleWebConnectors``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bWhatsNewExp``` | [See below](#bWhatsNewExp) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_General/bWhatsNewExp``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bEnableJS``` | [See below](#bEnableJS) | ```./User/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_JavaScript/bEnableJS``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bMIPCheckPolicyOnDocSave``` | [See below](#bMIPCheckPolicyOnDocSave) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_Security~Cat_MicrosoftPurviewInformationProtection/bMIPCheckPolicyOnDocSave``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bMIPLabelling``` | [See below](#bMIPLabelling) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_Security~Cat_MicrosoftPurviewInformationProtection/bMIPLabelling``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bAskBeforeInstalling``` | [See below](#bAskBeforeInstalling) | ```./User/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_Security/bAskBeforeInstalling``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bEnableCertificateBasedTrust``` | [See below](#bEnableCertificateBasedTrust) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_SecurityEnhanced/bEnableCertificateBasedTrust``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bEnhancedSecurityInBrowser``` | [See below](#bEnhancedSecurityInBrowser) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_SecurityEnhanced/bEnhancedSecurityInBrowser``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bEnhancedSecurityStandalone``` | [See below](#bEnhancedSecurityStandalone) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_SecurityEnhanced/bEnhancedSecurityStandalone``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bProtectedMode``` | [See below](#bProtectedMode) | ```./Device/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_SecurityEnhanced/bProtectedMode``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bTrustCertifiedDocuments``` | [See below](#bTrustCertifiedDocuments) | ```./User/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_SecurityEnhanced/bTrustCertifiedDocuments``` | String | ```<enabled/>```<br>```<disabled/>```
| ```bTrustOSTrustedSites``` | [See below](#bTrustOSTrustedSites) | ```./User/Vendor/MSFT/Policy/Config/AdobeAcrobatDC~Policy~Cat_Adobe_Acrobat_DC~Cat_Preferences~Cat_SecurityEnhanced/bTrustOSTrustedSites``` | String | ```<enabled/>```<br>```<disabled/>```
